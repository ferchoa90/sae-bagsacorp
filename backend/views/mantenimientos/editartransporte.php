...
$contenido2.='<div style="line-height:25px;"><b>Id:</b>&nbsp;&nbsp; '.strval($transporte->id).'</span><br>';
...
$(document).ready(function() {
    $("#guardar").on('click', function() {
        ...
        if (errors.length == 0) {
            ...
            datos.push({name: 'id', value: <?php echo $transporte->id; ?>});
            $.ajax({
