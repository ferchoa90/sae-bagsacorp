...
$contenido.='<div class="col-4 col-md-3"><b>Un. Bulto:</b>&nbsp; '.$producto->unibulto.'</span><br></div>';
$contenido.='<div class="col-4 col-md-3"><b>Descuento:</b>&nbsp; '.$producto->descuento.'</span><br></div>';
$contenido.='<div class="col-4 col-md-3"><b>Costo F.O.B:</b>&nbsp; '.$producto->costofob.'</span><br></div>';
$contenido.='<div class="col-4 col-md-3"><b>Costo Un.:</b>&nbsp; '.$producto->costoini.'</span><br></div>';
$contenido.='<div class="col-4 col-md-3"><b>Por Mayor:</b>&nbsp; '.$producto->preciomayor.'</span><br></div>';
$contenido.='<div class="col-4 col-md-3"><b>Distribuidor:</b>&nbsp; '.$producto->precio.'</span><br></div>';
$contenido.='<div class="col-4 col-md-3"><b>Distribuidor 1:</b>&nbsp; '.$producto->preciodist2.'</span><br></div>';
$contenido.='<div class="col-4 col-md-3"><b>Distribuidor 2:</b>&nbsp; '.$producto->preciodist3.'</span><br></div>';
$contenido.='<div class="col-4 col-md-3"><b>PVP:</b>&nbsp; '.$producto->preciopvp.'</span><br></div>';
$contenido.='<div class="col-4 col-md-3"><b>Descuento C.:</b>&nbsp; '.$producto->nombreproducto.'</span><br></div>';
