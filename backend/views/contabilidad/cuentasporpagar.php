...
$columnas= array(
    ...
    array('columna'=>'Fecha Cheque', 'datareg' => 'fechacheque', 'clase'=>'', 'estilo'=>'', 'ancho'=>'')  ,
...
echo $grid->getGrid(
        array(
            array('tipo'=>'datagrid','nombre'=>'table','id'=>'table','columnas'=>$columnas,'clase'=>'','style'=>'','col'=>'','adicional'=>'','url'=>'cuentasporpagarreg')
        )
);
